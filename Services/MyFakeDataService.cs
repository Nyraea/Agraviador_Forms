    ...
    public class MyFakeDataService : IMyFakeDataService
    {
        ...
        public MyFakeDataService() 
        {
            ...
            InstructorList = new List<Instructor>()
            {
                new Instructor()
                {
                    Id = 1, FirstName = "Totoy", LastName = "Bato", Birthday = DateTime.Parse("1990-03-19"), Email = "tbato@ust.edu.ph", IsTenured = false, SalaryPerHour = 500, Status = Status.Probationary
                },
                new Instructor()
                {
                Id = 1, FirstName = "Tina", LastName = "Totoy", Birthday = DateTime.Parse("1997-03-29"), Email = "totoy@ust.edu.ph", IsTenured = true, SalaryPerHour = 600, Status = Status.Permanent
                },
                new Instructor()
                {
                    Id = 1, FirstName = "Trucy", LastName = "Makalintag", Birthday = DateTime.Parse("2000-04-19"), Email = "tmakalintag@ust.edu.ph", IsTenured = false, SalaryPerHour = 560, Status = Status.Probationary
                }
